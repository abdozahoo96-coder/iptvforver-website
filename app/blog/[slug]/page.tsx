...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: 'Post Not Found - IPTV FORVER Blog',
      description: 'The requested blog post could not be found.'
    }
  }

  return {
    title: `${post.title.rendered} - IPTV FORVER Blog`,
    description: extractPlainText(post.excerpt.rendered, 160),
    keywords: 'IPTV forver, streaming, entertainment, technology',
    openGraph: {
            ...
            <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 text-center">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">
                  Interested in IPTV FORVER?
                </h3>
                <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 max-w-2xl mx-auto leading-relaxed">
                  Get premium IPTV forver access with 25,000+ channels and 26,000+ movies.
                  Contact us to learn more about our forver IPTV subscription plans.
                </p>
                <a
                  href="/pricing"
